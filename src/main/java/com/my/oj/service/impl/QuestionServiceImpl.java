...
import com.my.oj.mapper.QuestionMapper;
import com.my.oj.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    /**
     * 获取查询包装类（用户根据字段查询，根据前端传来的请求对象，得到mybatis框架支持的 QueryWrapper 类）
